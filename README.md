...
- لا يتم تخزين أي بيانات حساسة للمستخدمين باستثناء معرّف تيليجرام والاسم
...
هذا المشروع مرخص تحت ترخيص MIT - انظر ملف [LICENSE](LICENSE) للمزيد من التفاصيل.

---

تم التطوير بـ ❤️ باستخدام Python ومكتبات TeleBot, yt-dlp, وinstaloader
